...
# Save the trained model and label encoders for future use so that they can be loaded in model.py
# This allows the app_recommender.py to use the trained model without retraining.
import joblib

joblib.dump(lgb_model, 'lgb_model.pkl')
joblib.dump(label_encoder_career, 'label_encoder_career.pkl')
